...
positivePursuits <- which(godTiesMatrix == 1)

obscuredPursuits <- sample(positivePursuits, obscurePercent * positivePursuits)
...
updatePursuits <- function(agents, indivPursuitMats, indivTiesMatsList, godTiesMatrix){
  ...
  for(agent in 1:popSize){
    ...
    #add their new pursuits from this round (append first!!)
    indivPursuitMats[[agent]] <- indivPursuitMats[[agent]] + indivTiesMatsList[[agent]][[6]]
