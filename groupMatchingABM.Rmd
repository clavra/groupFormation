...
#getting info on the isolates

for(r in 1:length(igraph_list)){
  
print(V(igraph_list[[r]])[igraph::degree(igraph_list[[r]])==0])
...
a = V(igraph_list[[350]])$alliance

cols=setNames(colorRampPalette(c("blue", "red"))(length(unique(a))), sort(unique(a))) 

vertex.color=cols[as.character(a)]


  
plot(igraph_list[[350]],
