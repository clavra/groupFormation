...
for(m in 1:modelLoops) {
  ...
  results$population[results$generation == g & results$loop == m & results$strat == "mean"] <- stratTableOG["1"]
  results$population[results$generation == g & results$loop == m & results$strat == "min"] <- stratTableOG["2"]
