...
"PDG",
"APDG",
"XX") ##should I include NULL strategy?
...
#fold for alliance and gen, transpose for displacement to defense

overlap_new <- function(adjMat){
...
for(m in 1:modelLoops) {
  ...
  agents <- agentGenerate(popSize)
    ...
    for (t in 2:reassessments) {
      ...
      overlap_matrices <- overlap_new(pursuitMat)
...
random_matrix <- matrix(sample(1:100, replace = T), nrow = 20, ncol = 20)
